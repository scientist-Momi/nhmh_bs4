                        ...
                        <table width="100%" style="border-spacing: 0;">
                            ...
                            <tr>
                                <td style="padding:10px;text-align:left;">
                                    <p>Good day, Doctor {firstname} .</p>
                                    <p>This is an email to inform you that {patient_id} has cancelled her appointment with you slated for {app_date}.

                                    <p>Thanks for your service to<span style=" color: #1a8c97;font-weight: 600;">NHMH</span>.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
